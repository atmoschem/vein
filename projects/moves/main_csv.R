...
# file.copy(from = "../../baltimore/vein_simu_bu/csv/ef_rateperdistance.csv.gz", "csv")
# file.copy(from = "../../baltimore/vein_simu_bu/csv/ef_ratepervehicle.csv.gz", "csv")
...
path_ef_distance <- "csv/ef_rateperdistance.csv.gz"
path_ef_vehicle <- "csv/ef_ratepervehicle.csv.gz"

# 3.1 Fuel eval ####
source("scripts/fuel_eval_csv.R", encoding = "UTF-8")
rm(list = ls())
gc()
...
source("scripts/emissions_per_distance_csv.R", encoding = "UTF-8")
rm(list = ls())
gc()
...
source("scripts/emissions_per_distance_NMHC_csv.R", encoding = "UTF-8")
rm(list = ls())
gc()
...
source("scripts/emissions_per_vehicle_csv.R", encoding = "UTF-8")
rm(list = ls())
gc()
...
source("scripts/emissions_per_vehicle_NMHC_csv.R", encoding = "UTF-8")
rm(list = ls())
gc()
...
grid_width <- 200 # mts
crs <- 6487
source("scripts/post.R", encoding = "UTF-8", echo = TRUE)
rm(list = ls())
gc()
