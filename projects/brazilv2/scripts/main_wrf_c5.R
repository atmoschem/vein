...
# S4: Cenário Frota: renovação de frota. 
# Substituir todos os P3, P2, L3, L2 ou mais velhos. 
# Este cenário só afeta os veículos pesados. 
# Os outros veículos têm idade até 40 anos. 
# O consumo de combustível é igual às vendas.
...
# TODO: add in Excel
setDT(metadata)
metadata[family == "PC", maxage := 15]
metadata[family == "LCV", maxage := 15]
metadata[family == "TRUCKS", maxage := 17]
metadata[family == "BUS", maxage := 21]
