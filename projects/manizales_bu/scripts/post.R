...
# CO
x <- list.files(path = "emi/", pattern = "CO.csv", recursive = T, full.names = T)
...
# NOx
x <- list.files(path = "emi/", pattern = "NOx.csv", recursive = T, full.names = T)
...
# NO
x <- list.files(path = "emi/", pattern = "NO.csv", recursive = T, full.names = T)
...
# NO2
x <- list.files(path = "emi/", pattern = "NO2.csv", recursive = T, full.names = T)
...
# PM2.5
x <- list.files(path = "emi/", pattern = "PM.csv", recursive = T, full.names = T)
...
# PM10
x <- list.files(path = "emi/", pattern = "PM10.csv", recursive = T, full.names = T)
...
for(i in 1:nrow(tfs)) {
  xx[[paste0("V", 1:nrow(tfs))[i]]] <- Emissions(  xx[[paste0("V", 1:nrow(tfs))[i]]], time = "h")
}
