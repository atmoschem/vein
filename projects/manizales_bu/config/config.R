...
# im_ok ####
switch(language,
       "portuguese" = cat("Plotando fracción IM que pasan revisión \n"),
       "english" = cat("Plotting fraction that passes IM\n"),
       "spanish" = cat("Plotando fracção que pasa IM\n")
)
...
for (i in seq_along(n_veh)) {
  ...
  colplot(
    ...
    xlab = "Age of use",
    ylab = "",
    main = paste0("IM_OK ", names(n_veh)[i]),
    type = "l",
    pch = NULL,
    lwd = 1,
    theme = theme,
...
# im_co ####
switch(language,
       "portuguese" = cat("Plotando factor CO de reprobados\n"),
       "english" = cat("Plotting factor CO of reproved vehicles\n"),
       "spanish" = cat("Plotando factor CO de reprovados\n")
)
...
for (i in seq_along(n_veh)) {
  ...
  colplot(
    ...
    xlab = "Age of use",
    ylab = "",
    main = paste0("IM_CO ", names(n_veh)[i]),
    type = "l",
    pch = NULL,
    lwd = 1,
    theme = theme,
...
# im_hc ####
switch(language,
       "portuguese" = cat("Plotando factor HC de reprobados\n"),
       "english" = cat("Plotting factor HC of reproved vehicles\n"),
       "spanish" = cat("Plotando factor CH de reprovados\n")
)
...
for (i in seq_along(n_veh)) {
  ...
  colplot(
    ...
    xlab = "Age of use",
    ylab = "",
    main = paste0("IM_HC ", names(n_veh)[i]),
    type = "l",
    pch = NULL,
    lwd = 1,
    theme = theme,
...
# im_nox ####
switch(language,
       "portuguese" = cat("Plotando factor NOx de reprobados\n"),
       "english" = cat("Plotting factor NOx of reproved vehicles\n"),
       "spanish" = cat("Plotando factor NOx de reprovados\n")
)
...
for (i in seq_along(n_veh)) {
  ...
  colplot(
    ...
    xlab = "Age of use",
    ylab = "",
    main = paste0("IM_NOx ", names(n_veh)[i]),
    type = "l",
    pch = NULL,
    lwd = 1,
    theme = theme,
...
# im_pm ####
switch(language,
       "portuguese" = cat("Plotando factor PM de reprobados\n"),
       "english" = cat("Plotting factor PM of reproved vehicles\n"),
       "spanish" = cat("Plotando factor PM de reprovados\n")
)
...
for (i in seq_along(n_veh)) {
  ...
  colplot(
    ...
    xlab = "Age of use",
    ylab = "",
    main = paste0("IM_PM ", names(n_veh)[i]),
    type = "l",
    pch = NULL,
    lwd = 1,
    theme = theme,
...
vein_notes(
  notes = c("Notas proyecto manizales_bu_im",
            "bu es de bottom-up",
            "im significa que tiene incluido el efecto de IM con dados de Ecuador",
            "La hoja de fleet_age deberia ser ajustada para dar los porcentajes de la composicion",
            "Fue simulado free flow speed y capacity pero tiene que ser obtenido ese dato!"),
  file = "notes/README",
  title = paste0("Manizales province ", year),
  approach = "Bottom-up",
  traffic = "Flota",
  composition = "Ecuador",
