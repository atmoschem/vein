...
cat(paste0(
  ...
  "sum: ", round(kPC_G + kPC_E + kPC_FG +  kPC_FE, 2), "\n\n"))
...
cat(paste0(
  ...
  "SUM: ", 
  round(kLCV_G + kLCV_FG + kLCV_FE + kLCV_E + kLCV_D, 2), 
  "\n\n"
))
...
cat(paste0(
  ...
  "SUM: ",
  round(kTRUCKS_SL_D + kTRUCKS_L_D + kTRUCKS_M_D + kTRUCKS_SH_D + kTRUCKS_H_D, 2),
  "\n"
))
...
cat(paste0(
  ...
  "SUM: ",
  round(kBUS_URBAN_D + kBUS_MICRO_D + kBUS_COACH_D, 2),
  "\n\n"
))
...
cat(paste0(
  ...
  "SUM: ",
  round(kMC_150_G + kMC_150_500_G + kMC_500_G +
    kMC_150_FG + kMC_150_500_FG + kMC_500_FG +
    kMC_150_FE + kMC_150_500_FE + kMC_500_FE, 2),
  "\n\n"
))
...
png(
  filename = paste0("images/TRAFFIC_FINAL.png"),
