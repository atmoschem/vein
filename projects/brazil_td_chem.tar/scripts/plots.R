...
x <- readRDS("post/emi_street.rds")
ns <- names(x)[!grepl("geom", names(x))]
for (i in seq_along(ns)) {
  png(
    filename = paste0("images/STREETS_", ns[i], ".png"),
    width = 2100,
    height = 1500,
    units = "px",
    pointsize = 12,
...
for (i in seq_along(ns)) {
  png(
    filename = paste0("images/GRIDS_", ns[i], ".png"),
    width = 2100,
    height = 1500,
    units = "px",
    pointsize = 12,
...
for (i in seq_along(pol)) {
  ...
  png(
    filename = paste0("images/MONTH_", pol[i], ".png"),
    width = 2100, height = 1500, units = "px", pointsize = 12,
    bg = "white", res = 300
  )
  print(p)
