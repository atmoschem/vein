...
![](https://i.imgur.com/b2lQZzi.jpg){width=250px}
...
plot(PC_E25_1400net, main = "PC by age of use", axes = TRUE)
```
...
- [eixport::wrf_grid](https://github.com/atmoschem/eixport)
- [eixport::as4wrf](https://github.com/atmoschem/eixport)
