...
https://www.geosci-model-dev.net/11/2209/2018/
...
- [ef_cetesb](https://atmoschem.github.io/vein/reference/ef_cetesb.html) 
- [vein_notes](https://atmoschem.github.io/vein/reference/vein_notes.html) 
- VEIN imports **sf** functions.
- Covers estimations of compounds of pollutants (e.g.: isobutene)
- Add com util functions such as [emis_source](https://atmoschem.github.io/vein/reference/emis_source.html) to source vein scripts.
